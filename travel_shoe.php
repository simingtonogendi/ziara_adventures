            ...
            <div class="row text-primary">
                ...
                <div class="col-md-9">
                    ...
                    <section class="container">
                        ...
                        <br><br><br>
                        <div>
                            <p style="color: grey;font-size: 25px;">A shoe can make or break your holiday so chose wisely when planning your trip. Pro Tip: always buy your shoes as you plan the trip, it is less expensive and will save you the headache! To book your adventure trip email us at travel@ziaraadventures.com today!</p>
                        </div>
                        <br><br><br>
                        <div>
