...
<main id="main" class="site-main">
    ...
    <section class="site-section section-hello" id="intro">
        <div class="container">
            <h2>HELLO &amp; WELCOME</h2>
            <p class="section-subtitle"><span>LET US TAKE YOU AWAY</span></p>
        ...
        <div class="container center-block">
            ...
            <div class="row text-center txt">
               ...
               <p style="font-size: 20px">As Ziara adventures, we are committed to helping you create memories.</p>
                <p style="font-size: 20px">We provide a full range of travel management services to a diverse client portfolio We Bring you a modern, comfortable, and memorable travel experience. </p>

            </div>
        </div>
    </section><!-- /.section-about -->

    <section class="section-background background-budget background-overlay text-center">
        <div class="container">
            <div class="rectangle">
    ...
    <section class="site-section section-team" id="team">
        <div class="container">
            <h2>OUR TEAM</h2>
            <p class="section-subtitle"><span>THIS IS THE TEAM MAKING EVERYTHING POSSIBLE</span></p>
                            ...
                            <div class="flipper">
                                <div class="team-member-front">
                                    <div class="team-member-thumb">
                                        <img src="assets/img/wangeci-1.jpg" class="img-res" alt="">
                                    </div>  <!-- /.team-member-thumb -->
                                    <p class="team-member-front-name text-info">WANGECI KARUGE</p>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="team-member">
                            <div class="flipper">
                                <div class="team-member-front">
                                    <div class="team-member-thumb">
                                        <img src="assets/img/josphine.jpg" class="img-res" alt="">
                                    </div>  <!-- /.team-member-thumb -->
                                    <p class="team-member-front-name text-info">JOSPHINE WANJA</p>
                                </div><!-- /.team-member-front -->
                                <div class="team-member-back">
                                    <div class="team-member-info">
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="team-member">
                            <div class="flipper">
                                <div class="team-member-front">
                                    <div class="team-member-thumb">
                                        <img src="assets/img/brian.JPG" class="img-res" alt="">
                                    </div>  <!-- /.team-member-thumb -->
                                    <p class="team-member-front-name text-info">BRIAN KIRIMI</p>
                                </div><!-- /.team-member-front -->
                                <div class="team-member-back">
                                    <div class="team-member-info">
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="team-member">
                            <div class="flipper">
                                <div class="team-member-front">
                                    <div class="team-member-thumb">
                                        <img src="assets/img/symmingtone.jpg" class="img-res" alt="">
                                    </div>  <!-- /.team-member-thumb -->
                                    <p class="team-member-front-name text-info">SIMINGTON OCHIENG</p>
                                </div><!-- /.team-member-front -->
                                <div class="team-member-back">
                                    <div class="team-member-info">
