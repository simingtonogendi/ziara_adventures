            ...
            <div class="row text-primary">
                ...
                <div class="col-md-9">
                    ...
                    <section class="container">
                        ...
                        <br><br><br>
                        <div>
                            <p style="color: grey;font-size: 25px;">Some of these hidden adventure gems in Kenya are such well-kept secrets it almost feels illegal to spread the word! However, we at Ziara Adventures love adventure and live for such places. If you would like to know more about these places or plan your trip with us, reach us through travel@ziaraadventures.com</p>
                        </div>
                        <br><br><br>
                        <div>
