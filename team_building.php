    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-4 col-xs-12">
                <p><i class="fa fa-phone"></i><span> Phone</span>+254711715835/+254729471295</p>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-12">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a class="page-scroll" data-toggle="modal" title="A free Bootstrap video landing theme" href="home.php">Back</a>
                </li>
            </ul>
        </div>
    </div>
...
<nav class="navbar navbar-default templatemo-nav" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <div class="row">
                <div class="col-md-6">
                    <img src="assets/img/client.jpg" width="100" height="50" alt="logo">
                </div>
                <div class="col-md-6">
                    <a href="#" class="navbar-brand">#TWENDEZIARA</a>
                </div>
            </div>
        </div>
</nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                <h1 class="wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s"><span>Team </span>Building</h1>
                <div class="element">
                    <div class="sub-element">Change is effected through collaboration.</div>
                    <div class="sub-element">Trust is the backbone of teamwork.</div>
                    <div class="sub-element">Self made? Realisation of goals is by others' help.</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div id="ttr_content_margin"class="container-fluid">
                ...
                <div class="ttr_Home_html_row0 row">
                    <div class="post_column col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="ttr_Home_html_column00">
                            <div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
                            <div class="html_content"><p style="margin:0.36em 0.36em 0.36em 0em;text-align:Center;"><span
                                            style="font-family:'Ubuntu','Arial';font-size:2.5em;color:rgba(78,78,78,1);">About </span>
                                    <span style="font-family:'Ubuntu','Arial';font-weight:700;font-size:2.5em;color:rgba(0,203,203,1);">Team </span>
                                    <span style="font-family:'Ubuntu','Arial';font-size:2.5em;color:rgba(0,203,203,1);"> </span>
                                    <span style="font-family:'Ubuntu','Arial';font-size:2.5em;color:rgba(78,78,78,1);">Building</span>
                                </p><p style="margin:0.36em 0.36em 0.36em 0em;text-align:Center;"><br style="font-family:'Open Sans','Arial';font-size:1.714em;" />
                                </p><p style="margin:0.36em 0.36em 0.36em 0em;text-align:Center;line-height:2.11267605633803;">
                                    <span style="font-family:'Open Sans','Arial';font-size:1.286em;color:rgba(78,78,78,1);"></span></p><p style="margin:0.36em 0.36em 0.36em 0em;text-align:Center;line-height:2.11267605633803;"><span style="font-family:'Open Sans','Arial';font-size:1.286em;color:rgba(78,78,78,1);"></span></p>
                            </div>
                            <div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
                ...
                <section class="site-section section-services" id="services">
                    ...
                    <div class="container-fluid">
                        <h2>THE UPSIDE</h2>
                        <p class="section-subtitle"><span>Success Is Best When It's Shared</span></p>
                    </div>
                ...
                <section id="service">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s">OUR RECENT <span> TEAM</span> BUILDING<span> ACTIVITIES</span></h2>
                            </div>
                            <div class="col-md-4 wow fadeIn" data-wow-offset="50" data-wow-delay="0.6s">
                                <i class="fa fa-tags"></i>
                                <h4>Taro Works</h4>
                                <p>This was a post-pandemic team building activity which was done at Kereita Forest. The employees at Taro Works had been working from home and the need to re-introduce them into the on site working environment was there. The main aim of the team building activity was to improve on the communication and bonding among team members.</p>
                            </div>
                            <div class="col-md-4 active wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s">
                                <i class="fa fa-life-bouy"></i>
                                <h4>Savanna Brands</h4>
                                <p>There have been several team building activities conducted and which Savanna Brands took part in. The main aim is to ensure that the specific team building addresses the present needs of the team, this necessitates the need for tailoring the sessions.</p>
                            </div>
                            <div class="col-md-4 wow fadeIn" data-wow-offset="50" data-wow-delay="0.6s">
                                <i class="fa fa-hospital-o"></i>
                                <h4>City Health Hospital</h4>
                                <p>Having new employees means that they have to be adequately introduced into the environment you operate in. This is what informed this session with the company's goals and aspirations given focus. Such a session improves the bonding and understanding within the teams.</p>
                            </div>
                        </div>
                    </div>
                </section>
