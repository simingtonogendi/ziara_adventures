            ...
            <div class="row text-primary">
                ...
                <div class="col-md-9">
                    ...
                    <section class="container">
                        ...
                        <br><br><br>
                        <div>
                            <p style="color: grey;font-size: 25px;">The best time to start your logistics planning for any major event is EARLY… as early as 3 months before and if you are paranoid, start on the day the event is announced. When looking for a venue, accommodation, and travel options, reach out to us through Travel@ziaraadventures.com.</p>
                        </div>
                        <br><br><br>
                        <div>
